...
abstract class SimpleOrientationListener : OrientationEventListener {
    @Volatile
    ...
    override fun onOrientationChanged(orientation: Int) {
        ...
        if (prevOrientation != currentOrientation && orientation != ORIENTATION_UNKNOWN) {
            ...
            if (currentOrientation != ORIENTATION_UNKNOWN) reportOrientationChanged(currentOrientation)
        }
    }
